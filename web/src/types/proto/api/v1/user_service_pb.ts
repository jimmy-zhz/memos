...
export type UserSetting = Message<"memos.api.v1.UserSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.UserSetting.LastOpenedSetting last_opened_setting = 7;
     */
    value: UserSetting_LastOpenedSetting;
 ...
 *
 * @generated from message memos.api.v1.UserSetting.LastOpenedSetting
 */
export type UserSetting_LastOpenedSetting = Message<"memos.api.v1.UserSetting.LastOpenedSetting"> & {
  /**
   ...
   *
   * @generated from field: map<string, string> workspace_memos = 3;
   */
  workspaceMemos: { [key: string]: string };
};

/**
 * Describes the message memos.api.v1.UserSetting.LastOpenedSetting.
 * Use `create(UserSetting_LastOpenedSettingSchema)` to create a new message.
 */
export const UserSetting_LastOpenedSettingSchema: GenMessage<UserSetting_LastOpenedSetting> = /*@__PURE__*/
...
export enum UserSetting_Key {
  ...
  /**
   * LAST_OPENED is the key for the last workspace/document opened in the Notebook home page.
   *
   * @generated from enum value: LAST_OPENED = 6;
   */
  LAST_OPENED = 6,
}
