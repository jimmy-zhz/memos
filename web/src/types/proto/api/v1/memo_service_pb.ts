...
export type Memo = Message<"memos.api.v1.Memo"> & {
   ...
   *
   * @generated from field: string workspace = 19;
   */
  workspace: string;
   ...
   *
   * @generated from field: string folder_path = 20;
   */
  folderPath: string;
   ...
   *
   * @generated from field: memos.api.v1.Memo.DocType doc_type = 22;
   */
  docType: Memo_DocType;

  /**
   * Optional. Set when this memo is a comment anchored to a location within
   * a PDF attachment.
   *
   * @generated from field: optional memos.api.v1.PdfAnnotation pdf_annotation = 23;
   */
  pdfAnnotation?: PdfAnnotation | undefined;
};
...
/**
 * @generated from enum memos.api.v1.Memo.DocType
 */
export enum Memo_DocType {
  /**
  ...
  /**
   * @generated from enum value: PDF = 3;
   */
  PDF = 3,
...
/**
 * Describes the enum memos.api.v1.Memo.DocType.
 */
export const Memo_DocTypeSchema: GenEnum<Memo_DocType> = /*@__PURE__*/
  enumDesc(file_api_v1_memo_service, 1, 0);
...
/**
 * @generated from message memos.api.v1.PdfAnnotation
 */
export type PdfAnnotation = Message<"memos.api.v1.PdfAnnotation"> & {
  /**
   * The name of the attachment this annotation is anchored to.
   * Format: attachments/{uid}
   *
   * @generated from field: string attachment_name = 1;
   */
   ...
   *
   * @generated from field: string text_snippet = 7;
   */
  textSnippet: string;
};

/**
 * Describes the message memos.api.v1.PdfAnnotation.
 * Use `create(PdfAnnotationSchema)` to create a new message.
 */
export const PdfAnnotationSchema: GenMessage<PdfAnnotation> = /*@__PURE__*/
 ...
 *
 * @generated from message memos.api.v1.MemoHistory
 */
export type MemoHistory = Message<"memos.api.v1.MemoHistory"> & {
  /**
   ...
   *
   * @generated from field: repeated memos.api.v1.MemoHistory.Attachment attachments = 7;
   */
  attachments: MemoHistory_Attachment[];
};

/**
 * Describes the message memos.api.v1.MemoHistory.
 * Use `create(MemoHistorySchema)` to create a new message.
 */
export const MemoHistorySchema: GenMessage<MemoHistory> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 30);

/**
 * A lightweight reference to an attachment captured in a version snapshot.
 *
 * @generated from message memos.api.v1.MemoHistory.Attachment
 */
export type MemoHistory_Attachment = Message<"memos.api.v1.MemoHistory.Attachment"> & {
  /**
   * The attachment UID.
   *
...
/**
 * Describes the message memos.api.v1.MemoHistory.Attachment.
 * Use `create(MemoHistory_AttachmentSchema)` to create a new message.
 */
export const MemoHistory_AttachmentSchema: GenMessage<MemoHistory_Attachment> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 30, 0);

/**
 * @generated from message memos.api.v1.CreateMemoHistoryRequest
 */
export type CreateMemoHistoryRequest = Message<"memos.api.v1.CreateMemoHistoryRequest"> & {
  /**
   ...
   *
   * @generated from field: memos.api.v1.MemoHistory memo_history = 2;
   */
  memoHistory?: MemoHistory | undefined;
};

/**
 * Describes the message memos.api.v1.CreateMemoHistoryRequest.
 * Use `create(CreateMemoHistoryRequestSchema)` to create a new message.
 */
export const CreateMemoHistoryRequestSchema: GenMessage<CreateMemoHistoryRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 31);

/**
 * @generated from message memos.api.v1.ListMemoHistoriesRequest
 */
export type ListMemoHistoriesRequest = Message<"memos.api.v1.ListMemoHistoriesRequest"> & {
  /**
   * Required. The resource name of the memo.
   * Format: memos/{memo}
   *
...
/**
 * Describes the message memos.api.v1.ListMemoHistoriesRequest.
 * Use `create(ListMemoHistoriesRequestSchema)` to create a new message.
 */
export const ListMemoHistoriesRequestSchema: GenMessage<ListMemoHistoriesRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 32);

/**
 * @generated from message memos.api.v1.ListMemoHistoriesResponse
 */
export type ListMemoHistoriesResponse = Message<"memos.api.v1.ListMemoHistoriesResponse"> & {
  /**
   * The list of versions, newest first.
   *
   * @generated from field: repeated memos.api.v1.MemoHistory memo_histories = 1;
   */
  memoHistories: MemoHistory[];
};

/**
 * Describes the message memos.api.v1.ListMemoHistoriesResponse.
 * Use `create(ListMemoHistoriesResponseSchema)` to create a new message.
 */
export const ListMemoHistoriesResponseSchema: GenMessage<ListMemoHistoriesResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 33);

/**
 * @generated from message memos.api.v1.RestoreMemoHistoryRequest
 */
export type RestoreMemoHistoryRequest = Message<"memos.api.v1.RestoreMemoHistoryRequest"> & {
  /**
...
/**
 * Describes the message memos.api.v1.RestoreMemoHistoryRequest.
 * Use `create(RestoreMemoHistoryRequestSchema)` to create a new message.
 */
export const RestoreMemoHistoryRequestSchema: GenMessage<RestoreMemoHistoryRequest> = /*@__PURE__*/
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.CreateMemoHistory
   */
  createMemoHistory: {
    methodKind: "unary";
    input: typeof CreateMemoHistoryRequestSchema;
    output: typeof MemoHistorySchema;
  },
  /**
   * ListMemoHistories lists all saved versions for a memo, newest first.
   * Requires authentication as the memo creator.
   *
   * @generated from rpc memos.api.v1.MemoService.ListMemoHistories
   */
  listMemoHistories: {
    methodKind: "unary";
    input: typeof ListMemoHistoriesRequestSchema;
    output: typeof ListMemoHistoriesResponseSchema;
  },
  /**
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.RestoreMemoHistory
   */
  restoreMemoHistory: {
    methodKind: "unary";
    input: typeof RestoreMemoHistoryRequestSchema;
    output: typeof MemoSchema;
  },
  /**
